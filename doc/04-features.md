...
| Tecnologias   | `secoes/tecnologias`   | Seis grupos, 26 tecnologias, com nota opcional por grupo. Cada cartão traz ícone da marca (ou monograma) e uma frase de prova. A cor oficial da marca entra só no hover, por custom property |
